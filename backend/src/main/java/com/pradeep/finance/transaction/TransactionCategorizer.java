...
public class TransactionCategorizer {
    ...
    public String categorize(String description) {
        ...
        if (value.contains("transfer") || value.contains("e-payment") || value.contains("epayment") || value.contains("ccpymt") || value.contains("thank you") || value.contains("payment to crd") || value.contains("payment from chk") || value.contains("bank of america payment")) return "Transfer";
        ...
        if (value.contains("t-mobile") || value.contains("frontier online")) return "Utilities";
